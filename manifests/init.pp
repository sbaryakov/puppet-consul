...
#
# [*archive_provider*]
#   Which module is used to provide the archive defined resources.
#   Must be one of puppet/archive or camptocam/archive.
#   Default puppet/archive.
#
class consul (
  $manage_user           = true,
  $user                  = 'consul',
  ...
  $checks                = {},
  $acls                  = {},
  $archive_provider      = 'camptocamp/archive'
